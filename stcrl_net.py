"""
Spatiotemporal contrastive representation learning model
Pre-text task
...
class STCRL_Net(nn.Module):
    """
    Object based Spatiotemporal contrastive representation learning net (Object_STCRL_Net)
    Both bitemporal pre- & post- images are needed
    """

    def __init__(self, h_dim = 512, z_dim = 128, backbone_net='resnet18'):
        super(STCRL_Net, self).__init__()

        self.h_dim = h_dim # feature dimension
